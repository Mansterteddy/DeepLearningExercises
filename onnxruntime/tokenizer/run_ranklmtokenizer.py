...
def RankLMToken(g, input):
    return g.op("ai.onnx.contrib::RankLMTokenizer", input)
register_custom_op_symbolic('::RankLMTokenizer', RankLMToken, 1)


@onnx_op(op_type="RankLMTokenizer",
